...
than just writing on paper. If handwriting, the title or name of every entry should be underlined or otherwise highlighted; without some kind of structure, it can become confusing and hard to read.
...
Debrief reports may be done in a digital note, on the CONTEXT page used to plan the project,
...
is used to log what you have learned from previous successes and failures.

It is separate from the incident log and contains only events, both positive and negative, that you
believe have taught lasting and important lessons.

It can contain debriefing notes from large projects, or things as simple as internet "life hacks" you
...
Explicitly listing these brings them under conscious analysis, rather than leaving them
to chance.
...
Instead of just logging outcomes, describe sensory details, small surprises, and feelings. [^14]
...
Use a bookmark to quickly jump to a specific day.  Those who 
...
Headings level 1 and 2 should be centered, and all lower-level headings should 
be right-aligned.
